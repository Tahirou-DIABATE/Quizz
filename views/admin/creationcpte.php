                        ...
                        <div class="contain_4p"> <br>
                            ...
                            <form>
                                ...
                                <div class="" style="display: flex; flex-direction: row;">
                                    ...
                                    <button class="btn btn-primary" type="submit" style="margin-left: 90px; background-color:#51BFD0; border: none; height: 25px; margin-top: 20px; font-size: small;">Choisir un fichier</button>
                                </div>
                                    <button class="btn btn-primary" type="submit" style="margin-left: 80px; margin-bottom: 50px; background-color:#51BFD0; border: none; height: 25px; font-size: small;">Créer compte</button>
                                </form>
